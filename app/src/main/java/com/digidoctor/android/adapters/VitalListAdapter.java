...
import com.digidoctor.android.databinding.VitalViewBinding;
...
public class VitalListAdapter extends ListAdapter<VitalResponse.VitalDateVise, VitalListAdapter.VitalVH> {
    ...
    @NonNull
    @Override
    public VitalListAdapter.VitalVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull VitalListAdapter.VitalVH holder, int position) {
