...
import com.digidoctor.android.VideoCallActivity.CallReceiveActivity;
import com.digidoctor.android.VideoCallActivity.VideoActivity;
    ...
    public void showNotification(Context context, Intent intent) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            try {
                ...
                getManager(context).notify(timestamp/* ID of notification */, notificationBuilder.build());
